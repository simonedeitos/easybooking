...
CREATE TABLE IF NOT EXISTS `notifiche_config` (
    ...
    `reminder_lezioni_giorno_settimana` VARCHAR(10)    NOT NULL DEFAULT 'lun',
    ...
    `report_settimanale_giorno`        VARCHAR(10)     NOT NULL DEFAULT 'lun',
    `report_settimanale_ora`           TIME            NOT NULL DEFAULT '18:00:00',
    `report_settimanale_tipo`          VARCHAR(50)     NOT NULL DEFAULT 'lezioni',
    ...
    `report_mensile_tipo`              VARCHAR(50)     NOT NULL DEFAULT 'lezioni',
    `avviso_scadenza_enabled`          TINYINT(1)      NOT NULL DEFAULT 1,
    `avviso_scadenza_giorni`           INT             NOT NULL DEFAULT 7,
